  ...
  return (
    <div style={{ width: '100%', height: '100vh' }} className='d-flex justify-content-center align-items-center'>
      <div className="container w-75 ">
        ...
        <div className="card shadow p-5 " style={{backgroundColor:"#DF5D8B"}}>
          <div className="row align-items-center ">

            <div className="col-lg-12 d-flex flex-column justify-content-center align-items-center">
              <h1 className='fw-bolder text-light mt-4 mb-3'> <i style={{ height: '41px' }} className="fa-solid fa-image"></i> <span style={{color:'#DF5D8B'}}>My</span> Gallery</h1>
