...
function Footer() {
  return (
   ...
   <div className='mt-5'>
    ...
    <hr />
        <div style={{width:"100%", height:'300px'}} className='d-flex justify-content-center aolign-items-center flex-column  text-light mt-2 '>
        <div className='footer-content d-flex justify-content-evenly w-100 flex-wrap'>
    
          <div style={{width:'400px'}} className='website'>
            <h4>
              <i style={{height:'25px',color:'white'}} class="fa-regular fa-image "><span className='ms-2'>MyGallery</span></i>
            </h4>
            <h6>
          ...
          <div className='links d-flex flex-column'>
            ...
            <Link to={'/view'} style={{textDecoration:'none', color:'white'}}>View Images</Link>
        ...
        <p className='text-center'><b>Copyright @ 2024 MyGallery. Built with React</b></p>
    </div>
   </div>
